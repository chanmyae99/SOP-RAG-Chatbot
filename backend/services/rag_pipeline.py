...
Answer the question using ONLY the provided document excerpts and do not paraphrase and summarize.
...
When asked for quantities, weights, or capacities, look specifically for numerical values and units (e.g., kg, tons, SWL). These must be reported exactly as stated in the text or diagrams.
